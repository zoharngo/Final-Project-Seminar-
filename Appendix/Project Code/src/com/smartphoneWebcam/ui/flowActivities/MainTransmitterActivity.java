...
import com.smartphoneWebcam.R.string;
...
import com.smartphoneWebcam.server.TeaServer;
import com.smartphoneWebcam.ui.components.CameraView;
import com.smartphoneWebcam.ui.components.OverlayView;
import com.smartphoneWebcam.ui.components.StreamingLoop;
import com.smartphoneWebcam.ui.components.VideoFrame;
import com.smartphoneWebcam.ui.components.CameraView.CameraReadyCallback;

public class MainTransmitterActivity extends Activity implements View.OnTouchListener,
	...
	private OnClickListener exitAction = new OnClickListener() {
		...
		public void onClick(View v) {
			btnExit.setImageResource(R.drawable.exit_press);
			finish();
		}
	};
